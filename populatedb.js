...
function createBookInstances(cb) {
    async.parallel([
        ...
        function(callback) {
          bookInstanceCreate(books[1], ' Gollancz, 2011.', false, 'Borrowed', callback)
        },
        function(callback) {
        ...
        function(callback) {
          bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Damaged', callback)
        },
        function(callback) {
          bookInstanceCreate(books[4], 'New York, NY Tom Doherty Associates, LLC, 2015.', false, 'Borrowed', callback)
        },
        function(callback) {
